...
{
    public partial class dbproddec27Context : IdentityDbContext<
        AspNetUser, AspNetRole, int,
        AspNetUserClaim, AspNetUserRole, AspNetUserLogin,
        AspNetRoleClaim, AspNetUserToken>
    {
        public dbproddec27Context()
        {
        }

        public dbproddec27Context(DbContextOptions<dbproddec27Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.;Initial Catalog=db-prod-dec-27;Integrated Security=True;TrustServerCertificate=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetRole>(b =>
            {
                ...
                b.HasMany(e => e.AspNetRoleClaims)
                    .WithOne(e => e.Role)
            ...
            modelBuilder.Entity<AspNetUserRole>(entity =>
            {
                ...
                // Define relationships with AspNetUser and AspNetRole
            ...
            modelBuilder.Entity<ConsultForm>(entity =>
            {
                ...
                entity.Property(e => e.LastUpdatedStatusEnum).HasDefaultValueSql("((1))");
            ...
            modelBuilder.Entity<ConsultFormTimeline>(entity =>
            {
                ...
                entity.Property(e => e.PausedReason)
                    .HasMaxLength(2000)
                    .IsUnicode(false);
